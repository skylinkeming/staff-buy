...
export default function PartyManagement() {
    return (
        <div className="pl-5 flex flex-col gap-3.5 justify-between  w-full min-h-screen pt-5">
